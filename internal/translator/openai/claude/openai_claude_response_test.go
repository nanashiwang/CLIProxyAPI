...
func TestExtractOpenAIUsage(t *testing.T) {
	tests := []struct {
		...
		{name: "canonical wins", rawUsage: `{"prompt_tokens":100,"completion_tokens":50,"prompt_tokens_details":{"cache_write_tokens":40,"cache_creation_tokens":70}}`, wantInputTokens: 60, wantOutputTokens: 50, wantCacheWriteTokens: 40},
		{name: "zero canonical uses alias", rawUsage: `{"prompt_tokens":100,"completion_tokens":50,"prompt_tokens_details":{"cache_write_tokens":0,"cache_creation_tokens":40}}`, wantInputTokens: 60, wantOutputTokens: 50, wantCacheWriteTokens: 40},
		{name: "negative alias ignored", rawUsage: `{"prompt_tokens":100,"completion_tokens":50,"prompt_tokens_details":{"cache_creation_tokens":-10}}`, wantInputTokens: 100, wantOutputTokens: 50, wantCacheWriteTokens: -10},
	}
