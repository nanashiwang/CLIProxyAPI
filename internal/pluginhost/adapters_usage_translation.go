...
func (a *usageAdapter) HandleUsage(ctx context.Context, record coreusage.Record) {
	...
	plugin.HandleUsage(ctx, pluginapi.UsageRecord{
		...
		Billing: pluginapi.UsageBilling{
			Currency: record.Billing.Currency,
			Priced:   record.Billing.Priced,
			Reason:   record.Billing.Reason,
			TotalUSD: record.Billing.TotalUSD,
			Breakdown: pluginapi.UsageCostBreakdown{
				InputUSD:      record.Billing.Breakdown.InputUSD,
				OutputUSD:     record.Billing.Breakdown.OutputUSD,
				CacheReadUSD:  record.Billing.Breakdown.CacheReadUSD,
				CacheWriteUSD: record.Billing.Breakdown.CacheWriteUSD,
			},
			Pricing: pluginapi.UsagePricingSnapshot{
				Version:                record.Billing.Pricing.Version,
				Source:                 record.Billing.Pricing.Source,
				MatchedModel:           record.Billing.Pricing.MatchedModel,
				MatchedProvider:        record.Billing.Pricing.MatchedProvider,
				ServiceTier:            record.Billing.Pricing.ServiceTier,
				ContextThresholdTokens: record.Billing.Pricing.ContextThresholdTokens,
				UnitPricesUSDPerMillion: pluginapi.UsageUnitPrices{
					Input:      record.Billing.Pricing.UnitPricesUSDPerMillion.Input,
					Output:     record.Billing.Pricing.UnitPricesUSDPerMillion.Output,
					CacheRead:  record.Billing.Pricing.UnitPricesUSDPerMillion.CacheRead,
					CacheWrite: record.Billing.Pricing.UnitPricesUSDPerMillion.CacheWrite,
				},
				Estimated:    record.Billing.Pricing.Estimated,
				CalculatedAt: record.Billing.Pricing.CalculatedAt,
			},
		},
